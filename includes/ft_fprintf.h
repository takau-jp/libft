...
/*   Updated: 2025/06/30 15:58:27 by stanaka2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_reset_conversion(t_fprintf_ctx *ctx);
bool			ft_read_conversion(
					va_list *ap, const char **format, t_fprintf_ctx *ctx);
bool			ft_check_int_overflow(const char *format);
int				ft_atoi_precision(const char *format);
void			ft_fprint_char(t_fprintf_ctx *ctx, int c);
void			ft_fprint_strn(t_fprintf_ctx *ctx, char *s, size_t len);
bool			ft_fd_write_strn(int fd, char *s, size_t len);
void			ft_print_hexa_preffix(t_fprintf_ctx *ctx);
void			ft_print_conversion(va_list *ap, t_fprintf_ctx *ctx);
...
void			ft_conv_s(va_list *ap, t_fprintf_ctx *ctx);
void			ft_conv_d_i(va_list *ap, t_fprintf_ctx *ctx);
void			ft_conv_u(va_list *ap, t_fprintf_ctx *ctx);
void			ft_conv_x(va_list *ap, t_fprintf_ctx *ctx);
void			ft_conv_p(va_list *ap, t_fprintf_ctx *ctx);
void			ft_conv_percent(t_fprintf_ctx *ctx);
// extra (%o, %n, %f, %e, %g, %a, %Lf, %Le, %Lg, %lc, %ls)
void			ft_conv_o(va_list *ap, t_fprintf_ctx *ctx);
void			ft_conv_f_e_g(va_list *ap, t_fprintf_ctx *ctx);
void			ft_conv_a(va_list *ap, t_fprintf_ctx *ctx);
void			ft_conv_n(va_list *ap, t_fprintf_ctx *ctx);
// binary64
void			ft_conv_a_binary64(va_list *ap, t_fprintf_ctx *ctx);
void			ft_conv_e_binary64(va_list *ap, t_fprintf_ctx *ctx);
void			ft_conv_f_binary64(va_list *ap, t_fprintf_ctx *ctx);
void			ft_conv_g_binary64(va_list *ap, t_fprintf_ctx *ctx);
...
void			ft_print_g_exp_notation_binary64(t_fprintf_ctx *ctx,
					t_my_double *my_double, int decimal_exponent);
void			ft_print_g_fixed_point_binary64(t_fprintf_ctx *ctx,
					t_my_double *my_double, int decimal_exponent);
void			ft_print_nan_inf_binary64(
					t_fprintf_ctx *ctx, t_my_double *my_double);
void			ft_print_nan_inf_hex_binary64(
					t_fprintf_ctx *ctx, t_my_double_hex *my_double_hex);
...
// 80bit
void			ft_conv_e_80bit(va_list *ap, t_fprintf_ctx *ctx);
void			ft_conv_f_80bit(va_list *ap, t_fprintf_ctx *ctx);
void			ft_conv_g_80bit(va_list *ap, t_fprintf_ctx *ctx);
...
void			ft_print_g_exp_notation_80bit(t_fprintf_ctx *ctx,
					t_my_double *my_double, int decimal_exponent);
void			ft_print_g_fixed_point_80bit(t_fprintf_ctx *ctx,
					t_my_double *my_double, int decimal_exponent);
...
void			ft_print_exponent(t_fprintf_ctx *ctx, int decimal_exponent);
void			ft_print_exponent_hex(t_fprintf_ctx *ctx, int exp);
// wchar_t to UTF-8
void			ft_conv_lc(va_list *ap, t_fprintf_ctx *ctx);
void			ft_conv_ls(va_list *ap, t_fprintf_ctx *ctx);
void			ft_encode_wchar_to_utf8(
					unsigned char utf8[5], const wchar_t wc);
bool			ft_is_utf8_leading_byte(unsigned char byte);
void			ft_print_utf8(
					t_fprintf_ctx *ctx, unsigned char *utf8_str, size_t len);
