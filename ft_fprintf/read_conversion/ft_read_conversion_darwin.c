...
static void	ft_read_flags(const char **format, t_fprintf_ctx *ctx);
static bool	ft_read_width(va_list *ap,
				const char **format, t_fprintf_ctx *ctx);
static bool	ft_read_precision(va_list *ap,
				const char **format, t_fprintf_ctx *ctx);
static void	ft_read_length(const char **format, t_fprintf_ctx *ctx);

bool	ft_read_conversion(va_list *ap, const char **format, t_fprintf_ctx *ctx)
{
	(*format)++;
