...
/*   Updated: 2025/06/30 14:34:53 by stanaka2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_fprintf.h"

static void		ft_print_p(t_fprintf_ctx *ctx, uintptr_t pointer);
static size_t	ft_get_length_pointer(uintptr_t pointer);
static void		ft_print_pointer(t_fprintf_ctx *ctx, uintptr_t pointer);
static void		ft_print_p_null(t_fprintf_ctx *ctx);
...
static void	ft_print_pointer(t_fprintf_ctx *ctx, uintptr_t pointer)
{
	...
	ft_fprint_char(ctx, "0123456789abcdef"[pointer % 16]);
}
