...
/*   Updated: 2025/06/30 16:38:49 by stanaka2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_fprintf.h"

static int		ft_get_printable_precision_fixed_point(t_fprintf_ctx *ctx,
					t_my_double *my_double, int decimal_exp);
static size_t	ft_get_length_g_fixed_point(t_fprintf_ctx *ctx,
					t_my_double *my_double, int decimal_exp);
static void		ft_print_g_fixed_point_non_negative_exp(t_fprintf_ctx *ctx,
					t_my_double *my_double, int decimal_exp);
