...
/*   Updated: 2025/06/30 14:33:28 by stanaka2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_fprintf.h"

static void		ft_print_o(t_fprintf_ctx *ctx, uintmax_t num);
static size_t	ft_get_digits_uintmax_octal(uintmax_t num);
static void		ft_print_octal(t_fprintf_ctx *ctx, uintmax_t num);
...
static void	ft_print_octal(t_fprintf_ctx *ctx, uintmax_t num)
{
	...
	ft_fprint_char(ctx, "01234567"[num % 8]);
}
