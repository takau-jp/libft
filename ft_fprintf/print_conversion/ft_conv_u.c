...
/*   Updated: 2025/06/30 14:35:16 by stanaka2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_fprintf.h"

static void		ft_print_u(t_fprintf_ctx *ctx, uintmax_t num);
static size_t	ft_get_digits_uintmax(uintmax_t num);
static void		ft_print_unsigned(t_fprintf_ctx *ctx, uintmax_t num);
...
static void	ft_print_unsigned(t_fprintf_ctx *ctx, uintmax_t num)
{
	...
	ft_fprint_char(ctx, "0123456789"[num % 10]);
}
