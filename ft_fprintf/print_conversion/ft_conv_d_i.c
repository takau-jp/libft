...
/*   Updated: 2025/06/30 14:33:13 by stanaka2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_fprintf.h"

static void		ft_print_d_i(t_fprintf_ctx *ctx, intmax_t num);
static size_t	ft_get_digits_intmax(intmax_t num);
static void		ft_print_integer(t_fprintf_ctx *ctx, intmax_t num);
